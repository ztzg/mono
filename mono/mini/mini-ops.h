...
MINI_OP(OP_SH4_LOADI1_MEMBASE_R0,	"sh4_loadi1_membase_R0",	IREG, IREG, NONE)
MINI_OP(OP_SH4_LOADI1,			"sh4_loadi1",			IREG, IREG, NONE)
MINI_OP(OP_SH4_LOADI2_MEMBASE_R0,	"sh4_loadi2_membase_R0",	IREG, IREG, NONE)
MINI_OP(OP_SH4_LOADI2,			"sh4_loadi2",			IREG, IREG, NONE)
...
MINI_OP(OP_SH4_LOADI4_MEMBASE,		"sh4_loadi4_membase",		IREG, IREG, NONE)
MINI_OP(OP_SH4_LOADI4,			"sh4_loadi4",			IREG, IREG, NONE)
MINI_OP(OP_SH4_STOREI1_MEMBASE_R0,	"sh4_storei1_membase_R0",	IREG, IREG, NONE)
MINI_OP(OP_SH4_STOREI1,			"sh4_storei1",			IREG, IREG, NONE)
MINI_OP(OP_SH4_STOREI2_MEMBASE_R0,	"sh4_storei2_membase_R0",	IREG, IREG, NONE)
MINI_OP(OP_SH4_STOREI2,			"sh4_storei2",			IREG, IREG, NONE)
MINI_OP(OP_SH4_STOREI4_MEMBASE,		"sh4_storei4_membase",		IREG, IREG, NONE)
MINI_OP(OP_SH4_STOREI4,			"sh4_storei4",			IREG, IREG, NONE)
...
MINI_OP(OP_SH4_OR_IMM_R0,		"sh4_or_imm_R0",		IREG, IREG, NONE)
MINI_OP(OP_SH4_XOR_IMM_R0,		"sh4_xor_imm_R0",		IREG, IREG, NONE)
MINI_OP(OP_SH4_CMPGT,			"sh4_cmpgt",			NONE, IREG, IREG)
MINI_OP(OP_SH4_CMPHI,			"sh4_cmphi",			NONE, IREG, IREG)
MINI_OP(OP_SH4_CMPGE,			"sh4_cmpge",			NONE, IREG, IREG)
MINI_OP(OP_SH4_CMPHS,			"sh4_cmphs",			NONE, IREG, IREG)
MINI_OP(OP_SH4_REVERSE_CMPGT,		"sh4_reverse_cmpgt",		NONE, IREG, IREG)
MINI_OP(OP_SH4_REVERSE_CMPHI,		"sh4_reverse_cmphi",		NONE, IREG, IREG)
MINI_OP(OP_SH4_FCMPEQ,			"sh4_fcmpeq",			NONE, FREG, FREG)
MINI_OP(OP_SH4_FCMPGT,			"sh4_fcmpgt",			NONE, FREG, FREG)
...
MINI_OP(OP_SH4_PUSH_F32ARG,		"sh4_push_f32arg",		NONE, FREG, NONE)
MINI_OP(OP_SH4_PUSH_NATIVE_F32ARG,	"sh4_push_native_f32arg",		NONE, FREG, NONE)
MINI_OP(OP_SH4_PUSH_F64ARG,		"sh4_push_f64arg",		NONE, FREG, NONE)
MINI_OP(OP_SH4_SHLL1,			"sh4_shll1",			IREG, IREG, NONE)
MINI_OP(OP_SH4_SHLL2,			"sh4_shll2",			IREG, IREG, NONE)
MINI_OP(OP_SH4_SHLL8,			"sh4_shll8",			IREG, IREG, NONE)
MINI_OP(OP_SH4_SHLL16,			"sh4_shll16",			IREG, IREG, NONE)
MINI_OP(OP_SH4_SHAR1,			"sh4_shar1",			IREG, IREG, NONE)
MINI_OP(OP_SH4_SHLR1,			"sh4_shlr1",			IREG, IREG, NONE)
MINI_OP(OP_SH4_SHLR2,			"sh4_shlr2",			IREG, IREG, NONE)
MINI_OP(OP_SH4_SHLR8,			"sh4_shlr8",			IREG, IREG, NONE)
MINI_OP(OP_SH4_SHLR16,			"sh4_shlr16",			IREG, IREG, NONE)
MINI_OP(OP_SH4_CLRT,			"sh4_clrt",			NONE, NONE, NONE)
MINI_OP(OP_SH4_NEGC,			"sh4_negc",			IREG, IREG, NONE)
MINI_OP(OP_SH4_TST,			"sh4_tst",			NONE, IREG, IREG)
MINI_OP(OP_SH4_IADD_OVF,		"sh4_iadd_ovf",			IREG, IREG, IREG)
MINI_OP(OP_SH4_ISUB_OVF,		"sh4_isub_ovf",			IREG, IREG, IREG)
...
MINI_OP(OP_SH4_FCNVDS,			"sh4_fcnvds",			FREG, FREG, NONE)
MINI_OP(OP_SH4_ROTCL,			"sh4_rotcl",			IREG, IREG, NONE)
MINI_OP(OP_SH4_F32MOVEH,		"sh4_f32moveh",			FREG, FREG, NONE)
MINI_OP(OP_SH4_F32MOVEL,		"sh4_f32movel",			FREG, FREG, NONE)
