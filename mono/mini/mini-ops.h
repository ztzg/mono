...
MINI_OP(OP_SH4_LOAD_MEMBASE,	"sh4_load_membase", NONE, NONE, NONE)
MINI_OP(OP_SH4_LOADU1_MEMBASE,	"sh4_loadu1_membase", NONE, NONE, NONE)
MINI_OP(OP_SH4_CMPEQ,		"sh4_cmpeq", NONE, NONE, NONE)
MINI_OP(OP_SH4_CMPEQ_IMM_R0,	"sh4_cmpeq_imm_R0", NONE, NONE, NONE)
MINI_OP(OP_SH4_AND_IMM_R0,	"sh4_and_imm_R0", NONE, NONE, NONE)
MINI_OP(OP_SH4_OR_IMM_R0,	"sh4_or_imm_R0", NONE, NONE, NONE)
MINI_OP(OP_SH4_XOR_IMM_R0,	"sh4_xor_imm_R0", NONE, NONE, NONE)
MINI_OP(OP_SH4_CMPGT,		"sh4_cmpgt", NONE, NONE, NONE)
MINI_OP(OP_SH4_CMPHI,		"sh4_cmphi", NONE, NONE, NONE)
MINI_OP(OP_SH4_CMPGE,		"sh4_cmpge", NONE, NONE, NONE)
MINI_OP(OP_SH4_CMPHS,		"sh4_cmphs", NONE, NONE, NONE)
MINI_OP(OP_SH4_BT,		"sh4_bt", NONE, NONE, NONE)
MINI_OP(OP_SH4_BF,		"sh4_bf", NONE, NONE, NONE)
MINI_OP(OP_SH4_MOVT,		"sh4_movt", NONE, NONE, NONE)
#endif
