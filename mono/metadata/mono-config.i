...
# 105 "/.root0/usr/mips64el-gentoo-linux-gnu/gcc-bin/4.1.2/../../../lib/gcc/mips64el-gentoo-linux-gnu/4.1.2/include/stdarg.h" 3 4
...
# 8 "../../mono/metadata/metadata-internals.h" 2
...
# 16 "../../mono/metadata/appdomain.h" 2
...
# 8 "../../mono/metadata/domain-internals.h" 2
...
# 8 "../../mono/metadata/lock-tracer.h" 2
...
# 14 "../../mono/metadata/domain-internals.h" 2
...
# 19 "mono-config.c" 2
# 1 "../../mono/metadata/object-internals.h" 1
...
# 6 "../../mono/metadata/object-internals.h" 2


# 1 "../../mono/metadata/class-internals.h" 1
# 16 "../../mono/metadata/class-internals.h"
...
# 9 "../../mono/metadata/object-internals.h" 2
# 149 "../../mono/metadata/object-internals.h"
typedef struct {
 MonoObject obj;
 MonoObject *identity;
...
# 617 "../../mono/metadata/object-internals.h"
static inline MonoReflectionType*
monotype_cast (MonoObject *obj)
{
 do { if (__builtin_expect ((gsize)((!(obj) || (((MonoObject*)(obj))->vtable->klass->image == mono_defaults.corlib && ((MonoReflectionType*)(obj))->type != ((void *)0)))), 1)) ; else g_assertion_message_expr (((gchar*) 0), "../../mono/metadata/object-internals.h", 620, ((const char*) (__PRETTY_FUNCTION__)), "IS_MONOTYPE (obj)"); } while (0);
      ...
      GError **error)
{
 ...
 if (state->current) {
  ...
  if (__extension__ ({ size_t __s1_len, __s2_len; (__builtin_constant_p (state->current->element_name) && __builtin_constant_p (element_name) && (__s1_len = strlen (state->current->element_name), __s2_len = strlen (element_name), (!((size_t)(const void *)((state->current->element_name) + 1) - (size_t)(const void *)(state->current->element_name) == 1) || __s1_len >= 4) && (!((size_t)(const void *)((element_name) + 1) - (size_t)(const void *)(element_name) == 1) || __s2_len >= 4)) ? __builtin_strcmp (state->current->element_name, element_name) : (__builtin_constant_p (state->current->element_name) && ((size_t)(const void *)((state->current->element_name) + 1) - (size_t)(const void *)(state->current->element_name) == 1) && (__s1_len = strlen (state->current->element_name), __s1_len < 4) ? (__builtin_constant_p (element_name) && ((size_t)(const void *)((element_name) + 1) - (size_t)(const void *)(element_name) == 1) ? __builtin_strcmp (state->current->element_name, element_name) : (__extension__ ({ __const unsigned char *__s2 = (__const unsigned char *) (__const char *) (element_name); register int __result = (((__const unsigned char *) (__const char *) (state->current->element_name))[0] - __s2[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (state->current->element_name))[1] - __s2[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (state->current->element_name))[2] - __s2[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (state->current->element_name))[3] - __s2[3]); } } __result; }))) : (__builtin_constant_p (element_name) && ((size_t)(const void *)((element_name) + 1) - (size_t)(const void *)(element_name) == 1) && (__s2_len = strlen (element_name), __s2_len < 4) ? (__builtin_constant_p (state->current->element_name) && ((size_t)(const void *)((state->current->element_name) + 1) - (size_t)(const void *)(state->current->element_name) == 1) ? __builtin_strcmp (state->current->element_name, element_name) : (__extension__ ({ __const unsigned char *__s1 = (__const unsigned char *) (__const char *) (state->current->element_name); register int __result = __s1[0] - ((__const unsigned char *) (__const char *) (element_name))[0]; if (__s2_len > 0 && __result == 0) { __result = (__s1[1] - ((__const unsigned char *) (__const char *) (element_name))[1]); if (__s2_len > 1 && __result == 0) { __result = (__s1[2] - ((__const unsigned char *) (__const char *) (element_name))[2]); if (__s2_len > 2 && __result == 0) __result = (__s1[3] - ((__const unsigned char *) (__const char *) (element_name))[3]); } } __result; }))) : __builtin_strcmp (state->current->element_name, element_name)))); }) == 0) {
   if (state->current->finish)
    state->current->finish (state->user_data);
   state->current = ((void *)0);
   state->user_data = ((void *)0);
  }
 }
}
...
arch_matches (const char* arch, const char *value)
{
 ...
 while (*p) {
  if (__extension__ ({ size_t __s1_len, __s2_len; (__builtin_constant_p (arch) && __builtin_constant_p (*p) && (__s1_len = strlen (arch), __s2_len = strlen (*p), (!((size_t)(const void *)((arch) + 1) - (size_t)(const void *)(arch) == 1) || __s1_len >= 4) && (!((size_t)(const void *)((*p) + 1) - (size_t)(const void *)(*p) == 1) || __s2_len >= 4)) ? __builtin_strcmp (arch, *p) : (__builtin_constant_p (arch) && ((size_t)(const void *)((arch) + 1) - (size_t)(const void *)(arch) == 1) && (__s1_len = strlen (arch), __s1_len < 4) ? (__builtin_constant_p (*p) && ((size_t)(const void *)((*p) + 1) - (size_t)(const void *)(*p) == 1) ? __builtin_strcmp (arch, *p) : (__extension__ ({ __const unsigned char *__s2 = (__const unsigned char *) (__const char *) (*p); register int __result = (((__const unsigned char *) (__const char *) (arch))[0] - __s2[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (arch))[1] - __s2[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (arch))[2] - __s2[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (arch))[3] - __s2[3]); } } __result; }))) : (__builtin_constant_p (*p) && ((size_t)(const void *)((*p) + 1) - (size_t)(const void *)(*p) == 1) && (__s2_len = strlen (*p), __s2_len < 4) ? (__builtin_constant_p (arch) && ((size_t)(const void *)((arch) + 1) - (size_t)(const void *)(arch) == 1) ? __builtin_strcmp (arch, *p) : (__extension__ ({ __const unsigned char *__s1 = (__const unsigned char *) (__const char *) (arch); register int __result = __s1[0] - ((__const unsigned char *) (__const char *) (*p))[0]; if (__s2_len > 0 && __result == 0) { __result = (__s1[1] - ((__const unsigned char *) (__const char *) (*p))[1]); if (__s2_len > 1 && __result == 0) { __result = (__s1[2] - ((__const unsigned char *) (__const char *) (*p))[2]); if (__s2_len > 2 && __result == 0) __result = (__s1[3] - ((__const unsigned char *) (__const char *) (*p))[3]); } } __result; }))) : __builtin_strcmp (arch, *p)))); }) == 0) {
   found = (!(0));
   break;
  }
  p++;
...
dllmap_init (MonoImage *assembly) {
 DllInfo *info = ((DllInfo *) g_malloc0 (((gsize) sizeof (DllInfo)) * ((gsize) (1))));
              ...
              const gchar **attribute_values)
{
 ...
 if (__extension__ ({ size_t __s1_len, __s2_len; (__builtin_constant_p (element_name) && __builtin_constant_p ("dllmap") && (__s1_len = strlen (element_name), __s2_len = strlen ("dllmap"), (!((size_t)(const void *)((element_name) + 1) - (size_t)(const void *)(element_name) == 1) || __s1_len >= 4) && (!((size_t)(const void *)(("dllmap") + 1) - (size_t)(const void *)("dllmap") == 1) || __s2_len >= 4)) ? __builtin_strcmp (element_name, "dllmap") : (__builtin_constant_p (element_name) && ((size_t)(const void *)((element_name) + 1) - (size_t)(const void *)(element_name) == 1) && (__s1_len = strlen (element_name), __s1_len < 4) ? (__builtin_constant_p ("dllmap") && ((size_t)(const void *)(("dllmap") + 1) - (size_t)(const void *)("dllmap") == 1) ? __builtin_strcmp (element_name, "dllmap") : (__extension__ ({ __const unsigned char *__s2 = (__const unsigned char *) (__const char *) ("dllmap"); register int __result = (((__const unsigned char *) (__const char *) (element_name))[0] - __s2[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (element_name))[1] - __s2[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (element_name))[2] - __s2[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (element_name))[3] - __s2[3]); } } __result; }))) : (__builtin_constant_p ("dllmap") && ((size_t)(const void *)(("dllmap") + 1) - (size_t)(const void *)("dllmap") == 1) && (__s2_len = strlen ("dllmap"), __s2_len < 4) ? (__builtin_constant_p (element_name) && ((size_t)(const void *)((element_name) + 1) - (size_t)(const void *)(element_name) == 1) ? __builtin_strcmp (element_name, "dllmap") : (__extension__ ({ __const unsigned char *__s1 = (__const unsigned char *) (__const char *) (element_name); register int __result = __s1[0] - ((__const unsigned char *) (__const char *) ("dllmap"))[0]; if (__s2_len > 0 && __result == 0) { __result = (__s1[1] - ((__const unsigned char *) (__const char *) ("dllmap"))[1]); if (__s2_len > 1 && __result == 0) { __result = (__s1[2] - ((__const unsigned char *) (__const char *) ("dllmap"))[2]); if (__s2_len > 2 && __result == 0) __result = (__s1[3] - ((__const unsigned char *) (__const char *) ("dllmap"))[3]); } } __result; }))) : __builtin_strcmp (element_name, "dllmap")))); }) == 0) {
  g_free (info->dll);
  g_free (info->target);
  info->dll = info->target = ((void *)0);
  info->ignore = (0);
  for (i = 0; attribute_names [i]; ++i) {
   if (__extension__ ({ size_t __s1_len, __s2_len; (__builtin_constant_p (attribute_names [i]) && __builtin_constant_p ("dll") && (__s1_len = strlen (attribute_names [i]), __s2_len = strlen ("dll"), (!((size_t)(const void *)((attribute_names [i]) + 1) - (size_t)(const void *)(attribute_names [i]) == 1) || __s1_len >= 4) && (!((size_t)(const void *)(("dll") + 1) - (size_t)(const void *)("dll") == 1) || __s2_len >= 4)) ? __builtin_strcmp (attribute_names [i], "dll") : (__builtin_constant_p (attribute_names [i]) && ((size_t)(const void *)((attribute_names [i]) + 1) - (size_t)(const void *)(attribute_names [i]) == 1) && (__s1_len = strlen (attribute_names [i]), __s1_len < 4) ? (__builtin_constant_p ("dll") && ((size_t)(const void *)(("dll") + 1) - (size_t)(const void *)("dll") == 1) ? __builtin_strcmp (attribute_names [i], "dll") : (__extension__ ({ __const unsigned char *__s2 = (__const unsigned char *) (__const char *) ("dll"); register int __result = (((__const unsigned char *) (__const char *) (attribute_names [i]))[0] - __s2[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (attribute_names [i]))[1] - __s2[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (attribute_names [i]))[2] - __s2[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (attribute_names [i]))[3] - __s2[3]); } } __result; }))) : (__builtin_constant_p ("dll") && ((size_t)(const void *)(("dll") + 1) - (size_t)(const void *)("dll") == 1) && (__s2_len = strlen ("dll"), __s2_len < 4) ? (__builtin_constant_p (attribute_names [i]) && ((size_t)(const void *)((attribute_names [i]) + 1) - (size_t)(const void *)(attribute_names [i]) == 1) ? __builtin_strcmp (attribute_names [i], "dll") : (__extension__ ({ __const unsigned char *__s1 = (__const unsigned char *) (__const char *) (attribute_names [i]); register int __result = __s1[0] - ((__const unsigned char *) (__const char *) ("dll"))[0]; if (__s2_len > 0 && __result == 0) { __result = (__s1[1] - ((__const unsigned char *) (__const char *) ("dll"))[1]); if (__s2_len > 1 && __result == 0) { __result = (__s1[2] - ((__const unsigned char *) (__const char *) ("dll"))[2]); if (__s2_len > 2 && __result == 0) __result = (__s1[3] - ((__const unsigned char *) (__const char *) ("dll"))[3]); } } __result; }))) : __builtin_strcmp (attribute_names [i], "dll")))); }) == 0)
    info->dll = g_strdup (attribute_values [i]);
   else if (__extension__ ({ size_t __s1_len, __s2_len; (__builtin_constant_p (attribute_names [i]) && __builtin_constant_p ("target") && (__s1_len = strlen (attribute_names [i]), __s2_len = strlen ("target"), (!((size_t)(const void *)((attribute_names [i]) + 1) - (size_t)(const void *)(attribute_names [i]) == 1) || __s1_len >= 4) && (!((size_t)(const void *)(("target") + 1) - (size_t)(const void *)("target") == 1) || __s2_len >= 4)) ? __builtin_strcmp (attribute_names [i], "target") : (__builtin_constant_p (attribute_names [i]) && ((size_t)(const void *)((attribute_names [i]) + 1) - (size_t)(const void *)(attribute_names [i]) == 1) && (__s1_len = strlen (attribute_names [i]), __s1_len < 4) ? (__builtin_constant_p ("target") && ((size_t)(const void *)(("target") + 1) - (size_t)(const void *)("target") == 1) ? __builtin_strcmp (attribute_names [i], "target") : (__extension__ ({ __const unsigned char *__s2 = (__const unsigned char *) (__const char *) ("target"); register int __result = (((__const unsigned char *) (__const char *) (attribute_names [i]))[0] - __s2[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (attribute_names [i]))[1] - __s2[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (attribute_names [i]))[2] - __s2[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (attribute_names [i]))[3] - __s2[3]); } } __result; }))) : (__builtin_constant_p ("target") && ((size_t)(const void *)(("target") + 1) - (size_t)(const void *)("target") == 1) && (__s2_len = strlen ("target"), __s2_len < 4) ? (__builtin_constant_p (attribute_names [i]) && ((size_t)(const void *)((attribute_names [i]) + 1) - (size_t)(const void *)(attribute_names [i]) == 1) ? __builtin_strcmp (attribute_names [i], "target") : (__extension__ ({ __const unsigned char *__s1 = (__const unsigned char *) (__const char *) (attribute_names [i]); register int __result = __s1[0] - ((__const unsigned char *) (__const char *) ("target"))[0]; if (__s2_len > 0 && __result == 0) { __result = (__s1[1] - ((__const unsigned char *) (__const char *) ("target"))[1]); if (__s2_len > 1 && __result == 0) { __result = (__s1[2] - ((__const unsigned char *) (__const char *) ("target"))[2]); if (__s2_len > 2 && __result == 0) __result = (__s1[3] - ((__const unsigned char *) (__const char *) ("target"))[3]); } } __result; }))) : __builtin_strcmp (attribute_names [i], "target")))); }) == 0)
    info->target = g_strdup (attribute_values [i]);
   else if (__extension__ ({ size_t __s1_len, __s2_len; (__builtin_constant_p (attribute_names [i]) && __builtin_constant_p ("os") && (__s1_len = strlen (attribute_names [i]), __s2_len = strlen ("os"), (!((size_t)(const void *)((attribute_names [i]) + 1) - (size_t)(const void *)(attribute_names [i]) == 1) || __s1_len >= 4) && (!((size_t)(const void *)(("os") + 1) - (size_t)(const void *)("os") == 1) || __s2_len >= 4)) ? __builtin_strcmp (attribute_names [i], "os") : (__builtin_constant_p (attribute_names [i]) && ((size_t)(const void *)((attribute_names [i]) + 1) - (size_t)(const void *)(attribute_names [i]) == 1) && (__s1_len = strlen (attribute_names [i]), __s1_len < 4) ? (__builtin_constant_p ("os") && ((size_t)(const void *)(("os") + 1) - (size_t)(const void *)("os") == 1) ? __builtin_strcmp (attribute_names [i], "os") : (__extension__ ({ __const unsigned char *__s2 = (__const unsigned char *) (__const char *) ("os"); register int __result = (((__const unsigned char *) (__const char *) (attribute_names [i]))[0] - __s2[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (attribute_names [i]))[1] - __s2[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (attribute_names [i]))[2] - __s2[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (attribute_names [i]))[3] - __s2[3]); } } __result; }))) : (__builtin_constant_p ("os") && ((size_t)(const void *)(("os") + 1) - (size_t)(const void *)("os") == 1) && (__s2_len = strlen ("os"), __s2_len < 4) ? (__builtin_constant_p (attribute_names [i]) && ((size_t)(const void *)((attribute_names [i]) + 1) - (size_t)(const void *)(attribute_names [i]) == 1) ? __builtin_strcmp (attribute_names [i], "os") : (__extension__ ({ __const unsigned char *__s1 = (__const unsigned char *) (__const char *) (attribute_names [i]); register int __result = __s1[0] - ((__const unsigned char *) (__const char *) ("os"))[0]; if (__s2_len > 0 && __result == 0) { __result = (__s1[1] - ((__const unsigned char *) (__const char *) ("os"))[1]); if (__s2_len > 1 && __result == 0) { __result = (__s1[2] - ((__const unsigned char *) (__const char *) ("os"))[2]); if (__s2_len > 2 && __result == 0) __result = (__s1[3] - ((__const unsigned char *) (__const char *) ("os"))[3]); } } __result; }))) : __builtin_strcmp (attribute_names [i], "os")))); }) == 0 && !arch_matches ("linux", attribute_values [i]))
    info->ignore = (!(0));
   else if (__extension__ ({ size_t __s1_len, __s2_len; (__builtin_constant_p (attribute_names [i]) && __builtin_constant_p ("cpu") && (__s1_len = strlen (attribute_names [i]), __s2_len = strlen ("cpu"), (!((size_t)(const void *)((attribute_names [i]) + 1) - (size_t)(const void *)(attribute_names [i]) == 1) || __s1_len >= 4) && (!((size_t)(const void *)(("cpu") + 1) - (size_t)(const void *)("cpu") == 1) || __s2_len >= 4)) ? __builtin_strcmp (attribute_names [i], "cpu") : (__builtin_constant_p (attribute_names [i]) && ((size_t)(const void *)((attribute_names [i]) + 1) - (size_t)(const void *)(attribute_names [i]) == 1) && (__s1_len = strlen (attribute_names [i]), __s1_len < 4) ? (__builtin_constant_p ("cpu") && ((size_t)(const void *)(("cpu") + 1) - (size_t)(const void *)("cpu") == 1) ? __builtin_strcmp (attribute_names [i], "cpu") : (__extension__ ({ __const unsigned char *__s2 = (__const unsigned char *) (__const char *) ("cpu"); register int __result = (((__const unsigned char *) (__const char *) (attribute_names [i]))[0] - __s2[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (attribute_names [i]))[1] - __s2[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (attribute_names [i]))[2] - __s2[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (attribute_names [i]))[3] - __s2[3]); } } __result; }))) : (__builtin_constant_p ("cpu") && ((size_t)(const void *)(("cpu") + 1) - (size_t)(const void *)("cpu") == 1) && (__s2_len = strlen ("cpu"), __s2_len < 4) ? (__builtin_constant_p (attribute_names [i]) && ((size_t)(const void *)((attribute_names [i]) + 1) - (size_t)(const void *)(attribute_names [i]) == 1) ? __builtin_strcmp (attribute_names [i], "cpu") : (__extension__ ({ __const unsigned char *__s1 = (__const unsigned char *) (__const char *) (attribute_names [i]); register int __result = __s1[0] - ((__const unsigned char *) (__const char *) ("cpu"))[0]; if (__s2_len > 0 && __result == 0) { __result = (__s1[1] - ((__const unsigned char *) (__const char *) ("cpu"))[1]); if (__s2_len > 1 && __result == 0) { __result = (__s1[2] - ((__const unsigned char *) (__const char *) ("cpu"))[2]); if (__s2_len > 2 && __result == 0) __result = (__s1[3] - ((__const unsigned char *) (__const char *) ("cpu"))[3]); } } __result; }))) : __builtin_strcmp (attribute_names [i], "cpu")))); }) == 0 && !arch_matches ("mips", attribute_values [i]))
    info->ignore = (!(0));
   else if (__extension__ ({ size_t __s1_len, __s2_len; (__builtin_constant_p (attribute_names [i]) && __builtin_constant_p ("wordsize") && (__s1_len = strlen (attribute_names [i]), __s2_len = strlen ("wordsize"), (!((size_t)(const void *)((attribute_names [i]) + 1) - (size_t)(const void *)(attribute_names [i]) == 1) || __s1_len >= 4) && (!((size_t)(const void *)(("wordsize") + 1) - (size_t)(const void *)("wordsize") == 1) || __s2_len >= 4)) ? __builtin_strcmp (attribute_names [i], "wordsize") : (__builtin_constant_p (attribute_names [i]) && ((size_t)(const void *)((attribute_names [i]) + 1) - (size_t)(const void *)(attribute_names [i]) == 1) && (__s1_len = strlen (attribute_names [i]), __s1_len < 4) ? (__builtin_constant_p ("wordsize") && ((size_t)(const void *)(("wordsize") + 1) - (size_t)(const void *)("wordsize") == 1) ? __builtin_strcmp (attribute_names [i], "wordsize") : (__extension__ ({ __const unsigned char *__s2 = (__const unsigned char *) (__const char *) ("wordsize"); register int __result = (((__const unsigned char *) (__const char *) (attribute_names [i]))[0] - __s2[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (attribute_names [i]))[1] - __s2[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (attribute_names [i]))[2] - __s2[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (attribute_names [i]))[3] - __s2[3]); } } __result; }))) : (__builtin_constant_p ("wordsize") && ((size_t)(const void *)(("wordsize") + 1) - (size_t)(const void *)("wordsize") == 1) && (__s2_len = strlen ("wordsize"), __s2_len < 4) ? (__builtin_constant_p (attribute_names [i]) && ((size_t)(const void *)((attribute_names [i]) + 1) - (size_t)(const void *)(attribute_names [i]) == 1) ? __builtin_strcmp (attribute_names [i], "wordsize") : (__extension__ ({ __const unsigned char *__s1 = (__const unsigned char *) (__const char *) (attribute_names [i]); register int __result = __s1[0] - ((__const unsigned char *) (__const char *) ("wordsize"))[0]; if (__s2_len > 0 && __result == 0) { __result = (__s1[1] - ((__const unsigned char *) (__const char *) ("wordsize"))[1]); if (__s2_len > 1 && __result == 0) { __result = (__s1[2] - ((__const unsigned char *) (__const char *) ("wordsize"))[2]); if (__s2_len > 2 && __result == 0) __result = (__s1[3] - ((__const unsigned char *) (__const char *) ("wordsize"))[3]); } } __result; }))) : __builtin_strcmp (attribute_names [i], "wordsize")))); }) == 0 && !arch_matches ("32", attribute_values [i]))
    info->ignore = (!(0));
  }
  if (!info->ignore)
   mono_dllmap_insert (info->assembly, info->dll, ((void *)0), info->target, ((void *)0));
 } else if (__extension__ ({ size_t __s1_len, __s2_len; (__builtin_constant_p (element_name) && __builtin_constant_p ("dllentry") && (__s1_len = strlen (element_name), __s2_len = strlen ("dllentry"), (!((size_t)(const void *)((element_name) + 1) - (size_t)(const void *)(element_name) == 1) || __s1_len >= 4) && (!((size_t)(const void *)(("dllentry") + 1) - (size_t)(const void *)("dllentry") == 1) || __s2_len >= 4)) ? __builtin_strcmp (element_name, "dllentry") : (__builtin_constant_p (element_name) && ((size_t)(const void *)((element_name) + 1) - (size_t)(const void *)(element_name) == 1) && (__s1_len = strlen (element_name), __s1_len < 4) ? (__builtin_constant_p ("dllentry") && ((size_t)(const void *)(("dllentry") + 1) - (size_t)(const void *)("dllentry") == 1) ? __builtin_strcmp (element_name, "dllentry") : (__extension__ ({ __const unsigned char *__s2 = (__const unsigned char *) (__const char *) ("dllentry"); register int __result = (((__const unsigned char *) (__const char *) (element_name))[0] - __s2[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (element_name))[1] - __s2[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (element_name))[2] - __s2[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (element_name))[3] - __s2[3]); } } __result; }))) : (__builtin_constant_p ("dllentry") && ((size_t)(const void *)(("dllentry") + 1) - (size_t)(const void *)("dllentry") == 1) && (__s2_len = strlen ("dllentry"), __s2_len < 4) ? (__builtin_constant_p (element_name) && ((size_t)(const void *)((element_name) + 1) - (size_t)(const void *)(element_name) == 1) ? __builtin_strcmp (element_name, "dllentry") : (__extension__ ({ __const unsigned char *__s1 = (__const unsigned char *) (__const char *) (element_name); register int __result = __s1[0] - ((__const unsigned char *) (__const char *) ("dllentry"))[0]; if (__s2_len > 0 && __result == 0) { __result = (__s1[1] - ((__const unsigned char *) (__const char *) ("dllentry"))[1]); if (__s2_len > 1 && __result == 0) { __result = (__s1[2] - ((__const unsigned char *) (__const char *) ("dllentry"))[2]); if (__s2_len > 2 && __result == 0) __result = (__s1[3] - ((__const unsigned char *) (__const char *) ("dllentry"))[3]); } } __result; }))) : __builtin_strcmp (element_name, "dllentry")))); }) == 0) {
  const char *name = ((void *)0), *target = ((void *)0), *dll = ((void *)0);
  int ignore = (0);
  for (i = 0; attribute_names [i]; ++i) {
   if (__extension__ ({ size_t __s1_len, __s2_len; (__builtin_constant_p (attribute_names [i]) && __builtin_constant_p ("dll") && (__s1_len = strlen (attribute_names [i]), __s2_len = strlen ("dll"), (!((size_t)(const void *)((attribute_names [i]) + 1) - (size_t)(const void *)(attribute_names [i]) == 1) || __s1_len >= 4) && (!((size_t)(const void *)(("dll") + 1) - (size_t)(const void *)("dll") == 1) || __s2_len >= 4)) ? __builtin_strcmp (attribute_names [i], "dll") : (__builtin_constant_p (attribute_names [i]) && ((size_t)(const void *)((attribute_names [i]) + 1) - (size_t)(const void *)(attribute_names [i]) == 1) && (__s1_len = strlen (attribute_names [i]), __s1_len < 4) ? (__builtin_constant_p ("dll") && ((size_t)(const void *)(("dll") + 1) - (size_t)(const void *)("dll") == 1) ? __builtin_strcmp (attribute_names [i], "dll") : (__extension__ ({ __const unsigned char *__s2 = (__const unsigned char *) (__const char *) ("dll"); register int __result = (((__const unsigned char *) (__const char *) (attribute_names [i]))[0] - __s2[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (attribute_names [i]))[1] - __s2[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (attribute_names [i]))[2] - __s2[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (attribute_names [i]))[3] - __s2[3]); } } __result; }))) : (__builtin_constant_p ("dll") && ((size_t)(const void *)(("dll") + 1) - (size_t)(const void *)("dll") == 1) && (__s2_len = strlen ("dll"), __s2_len < 4) ? (__builtin_constant_p (attribute_names [i]) && ((size_t)(const void *)((attribute_names [i]) + 1) - (size_t)(const void *)(attribute_names [i]) == 1) ? __builtin_strcmp (attribute_names [i], "dll") : (__extension__ ({ __const unsigned char *__s1 = (__const unsigned char *) (__const char *) (attribute_names [i]); register int __result = __s1[0] - ((__const unsigned char *) (__const char *) ("dll"))[0]; if (__s2_len > 0 && __result == 0) { __result = (__s1[1] - ((__const unsigned char *) (__const char *) ("dll"))[1]); if (__s2_len > 1 && __result == 0) { __result = (__s1[2] - ((__const unsigned char *) (__const char *) ("dll"))[2]); if (__s2_len > 2 && __result == 0) __result = (__s1[3] - ((__const unsigned char *) (__const char *) ("dll"))[3]); } } __result; }))) : __builtin_strcmp (attribute_names [i], "dll")))); }) == 0)
   ...
   else if (__extension__ ({ size_t __s1_len, __s2_len; (__builtin_constant_p (attribute_names [i]) && __builtin_constant_p ("name") && (__s1_len = strlen (attribute_names [i]), __s2_len = strlen ("name"), (!((size_t)(const void *)((attribute_names [i]) + 1) - (size_t)(const void *)(attribute_names [i]) == 1) || __s1_len >= 4) && (!((size_t)(const void *)(("name") + 1) - (size_t)(const void *)("name") == 1) || __s2_len >= 4)) ? __builtin_strcmp (attribute_names [i], "name") : (__builtin_constant_p (attribute_names [i]) && ((size_t)(const void *)((attribute_names [i]) + 1) - (size_t)(const void *)(attribute_names [i]) == 1) && (__s1_len = strlen (attribute_names [i]), __s1_len < 4) ? (__builtin_constant_p ("name") && ((size_t)(const void *)(("name") + 1) - (size_t)(const void *)("name") == 1) ? __builtin_strcmp (attribute_names [i], "name") : (__extension__ ({ __const unsigned char *__s2 = (__const unsigned char *) (__const char *) ("name"); register int __result = (((__const unsigned char *) (__const char *) (attribute_names [i]))[0] - __s2[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (attribute_names [i]))[1] - __s2[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (attribute_names [i]))[2] - __s2[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (attribute_names [i]))[3] - __s2[3]); } } __result; }))) : (__builtin_constant_p ("name") && ((size_t)(const void *)(("name") + 1) - (size_t)(const void *)("name") == 1) && (__s2_len = strlen ("name"), __s2_len < 4) ? (__builtin_constant_p (attribute_names [i]) && ((size_t)(const void *)((attribute_names [i]) + 1) - (size_t)(const void *)(attribute_names [i]) == 1) ? __builtin_strcmp (attribute_names [i], "name") : (__extension__ ({ __const unsigned char *__s1 = (__const unsigned char *) (__const char *) (attribute_names [i]); register int __result = __s1[0] - ((__const unsigned char *) (__const char *) ("name"))[0]; if (__s2_len > 0 && __result == 0) { __result = (__s1[1] - ((__const unsigned char *) (__const char *) ("name"))[1]); if (__s2_len > 1 && __result == 0) { __result = (__s1[2] - ((__const unsigned char *) (__const char *) ("name"))[2]); if (__s2_len > 2 && __result == 0) __result = (__s1[3] - ((__const unsigned char *) (__const char *) ("name"))[3]); } } __result; }))) : __builtin_strcmp (attribute_names [i], "name")))); }) == 0)
...
legacyUEP_start (gpointer user_data,
              ...
              const gchar **attribute_names,
              const gchar **attribute_values) {
 if ((__extension__ ({ size_t __s1_len, __s2_len; (__builtin_constant_p (element_name) && __builtin_constant_p ("legacyUnhandledExceptionPolicy") && (__s1_len = strlen (element_name), __s2_len = strlen ("legacyUnhandledExceptionPolicy"), (!((size_t)(const void *)((element_name) + 1) - (size_t)(const void *)(element_name) == 1) || __s1_len >= 4) && (!((size_t)(const void *)(("legacyUnhandledExceptionPolicy") + 1) - (size_t)(const void *)("legacyUnhandledExceptionPolicy") == 1) || __s2_len >= 4)) ? __builtin_strcmp (element_name, "legacyUnhandledExceptionPolicy") : (__builtin_constant_p (element_name) && ((size_t)(const void *)((element_name) + 1) - (size_t)(const void *)(element_name) == 1) && (__s1_len = strlen (element_name), __s1_len < 4) ? (__builtin_constant_p ("legacyUnhandledExceptionPolicy") && ((size_t)(const void *)(("legacyUnhandledExceptionPolicy") + 1) - (size_t)(const void *)("legacyUnhandledExceptionPolicy") == 1) ? __builtin_strcmp (element_name, "legacyUnhandledExceptionPolicy") : (__extension__ ({ __const unsigned char *__s2 = (__const unsigned char *) (__const char *) ("legacyUnhandledExceptionPolicy"); register int __result = (((__const unsigned char *) (__const char *) (element_name))[0] - __s2[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (element_name))[1] - __s2[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (element_name))[2] - __s2[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (element_name))[3] - __s2[3]); } } __result; }))) : (__builtin_constant_p ("legacyUnhandledExceptionPolicy") && ((size_t)(const void *)(("legacyUnhandledExceptionPolicy") + 1) - (size_t)(const void *)("legacyUnhandledExceptionPolicy") == 1) && (__s2_len = strlen ("legacyUnhandledExceptionPolicy"), __s2_len < 4) ? (__builtin_constant_p (element_name) && ((size_t)(const void *)((element_name) + 1) - (size_t)(const void *)(element_name) == 1) ? __builtin_strcmp (element_name, "legacyUnhandledExceptionPolicy") : (__extension__ ({ __const unsigned char *__s1 = (__const unsigned char *) (__const char *) (element_name); register int __result = __s1[0] - ((__const unsigned char *) (__const char *) ("legacyUnhandledExceptionPolicy"))[0]; if (__s2_len > 0 && __result == 0) { __result = (__s1[1] - ((__const unsigned char *) (__const char *) ("legacyUnhandledExceptionPolicy"))[1]); if (__s2_len > 1 && __result == 0) { __result = (__s1[2] - ((__const unsigned char *) (__const char *) ("legacyUnhandledExceptionPolicy"))[2]); if (__s2_len > 2 && __result == 0) __result = (__s1[3] - ((__const unsigned char *) (__const char *) ("legacyUnhandledExceptionPolicy"))[3]); } } __result; }))) : __builtin_strcmp (element_name, "legacyUnhandledExceptionPolicy")))); }) == 0) &&
   (attribute_names [0] != ((void *)0)) &&
   (__extension__ ({ size_t __s1_len, __s2_len; (__builtin_constant_p (attribute_names [0]) && __builtin_constant_p ("enabled") && (__s1_len = strlen (attribute_names [0]), __s2_len = strlen ("enabled"), (!((size_t)(const void *)((attribute_names [0]) + 1) - (size_t)(const void *)(attribute_names [0]) == 1) || __s1_len >= 4) && (!((size_t)(const void *)(("enabled") + 1) - (size_t)(const void *)("enabled") == 1) || __s2_len >= 4)) ? __builtin_strcmp (attribute_names [0], "enabled") : (__builtin_constant_p (attribute_names [0]) && ((size_t)(const void *)((attribute_names [0]) + 1) - (size_t)(const void *)(attribute_names [0]) == 1) && (__s1_len = strlen (attribute_names [0]), __s1_len < 4) ? (__builtin_constant_p ("enabled") && ((size_t)(const void *)(("enabled") + 1) - (size_t)(const void *)("enabled") == 1) ? __builtin_strcmp (attribute_names [0], "enabled") : (__extension__ ({ __const unsigned char *__s2 = (__const unsigned char *) (__const char *) ("enabled"); register int __result = (((__const unsigned char *) (__const char *) (attribute_names [0]))[0] - __s2[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (attribute_names [0]))[1] - __s2[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (attribute_names [0]))[2] - __s2[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (attribute_names [0]))[3] - __s2[3]); } } __result; }))) : (__builtin_constant_p ("enabled") && ((size_t)(const void *)(("enabled") + 1) - (size_t)(const void *)("enabled") == 1) && (__s2_len = strlen ("enabled"), __s2_len < 4) ? (__builtin_constant_p (attribute_names [0]) && ((size_t)(const void *)((attribute_names [0]) + 1) - (size_t)(const void *)(attribute_names [0]) == 1) ? __builtin_strcmp (attribute_names [0], "enabled") : (__extension__ ({ __const unsigned char *__s1 = (__const unsigned char *) (__const char *) (attribute_names [0]); register int __result = __s1[0] - ((__const unsigned char *) (__const char *) ("enabled"))[0]; if (__s2_len > 0 && __result == 0) { __result = (__s1[1] - ((__const unsigned char *) (__const char *) ("enabled"))[1]); if (__s2_len > 1 && __result == 0) { __result = (__s1[2] - ((__const unsigned char *) (__const char *) ("enabled"))[2]); if (__s2_len > 2 && __result == 0) __result = (__s1[3] - ((__const unsigned char *) (__const char *) ("enabled"))[3]); } } __result; }))) : __builtin_strcmp (attribute_names [0], "enabled")))); }) == 0)) {
  if ((__extension__ ({ size_t __s1_len, __s2_len; (__builtin_constant_p (attribute_values [0]) && __builtin_constant_p ("1") && (__s1_len = strlen (attribute_values [0]), __s2_len = strlen ("1"), (!((size_t)(const void *)((attribute_values [0]) + 1) - (size_t)(const void *)(attribute_values [0]) == 1) || __s1_len >= 4) && (!((size_t)(const void *)(("1") + 1) - (size_t)(const void *)("1") == 1) || __s2_len >= 4)) ? __builtin_strcmp (attribute_values [0], "1") : (__builtin_constant_p (attribute_values [0]) && ((size_t)(const void *)((attribute_values [0]) + 1) - (size_t)(const void *)(attribute_values [0]) == 1) && (__s1_len = strlen (attribute_values [0]), __s1_len < 4) ? (__builtin_constant_p ("1") && ((size_t)(const void *)(("1") + 1) - (size_t)(const void *)("1") == 1) ? __builtin_strcmp (attribute_values [0], "1") : (__extension__ ({ __const unsigned char *__s2 = (__const unsigned char *) (__const char *) ("1"); register int __result = (((__const unsigned char *) (__const char *) (attribute_values [0]))[0] - __s2[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (attribute_values [0]))[1] - __s2[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (attribute_values [0]))[2] - __s2[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (attribute_values [0]))[3] - __s2[3]); } } __result; }))) : (__builtin_constant_p ("1") && ((size_t)(const void *)(("1") + 1) - (size_t)(const void *)("1") == 1) && (__s2_len = strlen ("1"), __s2_len < 4) ? (__builtin_constant_p (attribute_values [0]) && ((size_t)(const void *)((attribute_values [0]) + 1) - (size_t)(const void *)(attribute_values [0]) == 1) ? __builtin_strcmp (attribute_values [0], "1") : (__extension__ ({ __const unsigned char *__s1 = (__const unsigned char *) (__const char *) (attribute_values [0]); register int __result = __s1[0] - ((__const unsigned char *) (__const char *) ("1"))[0]; if (__s2_len > 0 && __result == 0) { __result = (__s1[1] - ((__const unsigned char *) (__const char *) ("1"))[1]); if (__s2_len > 1 && __result == 0) { __result = (__s1[2] - ((__const unsigned char *) (__const char *) ("1"))[2]); if (__s2_len > 2 && __result == 0) __result = (__s1[3] - ((__const unsigned char *) (__const char *) ("1"))[3]); } } __result; }))) : __builtin_strcmp (attribute_values [0], "1")))); }) == 0) ||
...
mono_config_parse_xml_with_context (ParseState *state, const char *text, gsize len)
{
 ...
 context = g_markup_parse_context_new (&mono_parser, 0, state, ((void *)0));
 if (g_markup_parse_context_parse (context, text, len, ((void *)0))) {
  g_markup_parse_context_end_parse (context, ((void *)0));
 }
...
mono_config_parse_file_with_context (ParseState *state, const char *filename)
{
 ...
 if (!g_file_get_contents (filename, &text, &len, ((void *)0)))
  return 0;
...
static BundledConfig *bundled_configs = ((void *)0);

static const char *bundled_machine_config = ((void *)0);
...
mono_register_config_for_assembly (const char* assembly_name, const char* config_xml)
{
 ...
 bconfig = ((BundledConfig *) g_malloc0 (((gsize) sizeof (BundledConfig)) * ((gsize) (1))));
...
mono_config_string_for_assembly_file (const char *filename)
{
 ...
 for (bconfig = bundled_configs; bconfig; bconfig = bconfig->next) {
  if (bconfig->aname && __extension__ ({ size_t __s1_len, __s2_len; (__builtin_constant_p (bconfig->aname) && __builtin_constant_p (filename) && (__s1_len = strlen (bconfig->aname), __s2_len = strlen (filename), (!((size_t)(const void *)((bconfig->aname) + 1) - (size_t)(const void *)(bconfig->aname) == 1) || __s1_len >= 4) && (!((size_t)(const void *)((filename) + 1) - (size_t)(const void *)(filename) == 1) || __s2_len >= 4)) ? __builtin_strcmp (bconfig->aname, filename) : (__builtin_constant_p (bconfig->aname) && ((size_t)(const void *)((bconfig->aname) + 1) - (size_t)(const void *)(bconfig->aname) == 1) && (__s1_len = strlen (bconfig->aname), __s1_len < 4) ? (__builtin_constant_p (filename) && ((size_t)(const void *)((filename) + 1) - (size_t)(const void *)(filename) == 1) ? __builtin_strcmp (bconfig->aname, filename) : (__extension__ ({ __const unsigned char *__s2 = (__const unsigned char *) (__const char *) (filename); register int __result = (((__const unsigned char *) (__const char *) (bconfig->aname))[0] - __s2[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (bconfig->aname))[1] - __s2[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (bconfig->aname))[2] - __s2[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (bconfig->aname))[3] - __s2[3]); } } __result; }))) : (__builtin_constant_p (filename) && ((size_t)(const void *)((filename) + 1) - (size_t)(const void *)(filename) == 1) && (__s2_len = strlen (filename), __s2_len < 4) ? (__builtin_constant_p (bconfig->aname) && ((size_t)(const void *)((bconfig->aname) + 1) - (size_t)(const void *)(bconfig->aname) == 1) ? __builtin_strcmp (bconfig->aname, filename) : (__extension__ ({ __const unsigned char *__s1 = (__const unsigned char *) (__const char *) (bconfig->aname); register int __result = __s1[0] - ((__const unsigned char *) (__const char *) (filename))[0]; if (__s2_len > 0 && __result == 0) { __result = (__s1[1] - ((__const unsigned char *) (__const char *) (filename))[1]); if (__s2_len > 1 && __result == 0) { __result = (__s1[2] - ((__const unsigned char *) (__const char *) (filename))[2]); if (__s2_len > 2 && __result == 0) __result = (__s1[3] - ((__const unsigned char *) (__const char *) (filename))[3]); } } __result; }))) : __builtin_strcmp (bconfig->aname, filename)))); }) == 0)
...
mono_config_for_assembly (MonoImage *assembly)
{
 ...
 for (i = 0; (aname = get_assembly_filename (assembly, i)) != ((void *)0); ++i) {
  cfg = g_build_filename (mono_get_config_dir (), "mono", "assemblies", aname, cfg_name, ((void *)0));
  got_it += mono_config_parse_file_with_context (&state, cfg);
  g_free (cfg);


  cfg = g_build_filename (home, ".mono", "assemblies", aname, cfg_name, ((void *)0));
  got_it += mono_config_parse_file_with_context (&state, cfg);
  g_free (cfg);
...
mono_config_parse (const char *filename) {
 ...
 mono_cfg = g_build_filename (mono_get_config_dir (), "mono", "config", ((void *)0));
 mono_config_parse_file (mono_cfg);
 g_free (mono_cfg);


 home = g_get_home_dir ();
 user_cfg = g_strconcat (home, "/", ".mono/config", ((void *)0));
 mono_config_parse_file (user_cfg);
 g_free (user_cfg);

}

static const char *mono_cfg_dir = ((void *)0);
  ...
  const gchar **attribute_values)
{
 ...
 info = user_data;
 if (!__extension__ ({ size_t __s1_len, __s2_len; (__builtin_constant_p (element_name) && __builtin_constant_p ("assemblyIdentity") && (__s1_len = strlen (element_name), __s2_len = strlen ("assemblyIdentity"), (!((size_t)(const void *)((element_name) + 1) - (size_t)(const void *)(element_name) == 1) || __s1_len >= 4) && (!((size_t)(const void *)(("assemblyIdentity") + 1) - (size_t)(const void *)("assemblyIdentity") == 1) || __s2_len >= 4)) ? __builtin_strcmp (element_name, "assemblyIdentity") : (__builtin_constant_p (element_name) && ((size_t)(const void *)((element_name) + 1) - (size_t)(const void *)(element_name) == 1) && (__s1_len = strlen (element_name), __s1_len < 4) ? (__builtin_constant_p ("assemblyIdentity") && ((size_t)(const void *)(("assemblyIdentity") + 1) - (size_t)(const void *)("assemblyIdentity") == 1) ? __builtin_strcmp (element_name, "assemblyIdentity") : (__extension__ ({ __const unsigned char *__s2 = (__const unsigned char *) (__const char *) ("assemblyIdentity"); register int __result = (((__const unsigned char *) (__const char *) (element_name))[0] - __s2[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (element_name))[1] - __s2[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (element_name))[2] - __s2[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (element_name))[3] - __s2[3]); } } __result; }))) : (__builtin_constant_p ("assemblyIdentity") && ((size_t)(const void *)(("assemblyIdentity") + 1) - (size_t)(const void *)("assemblyIdentity") == 1) && (__s2_len = strlen ("assemblyIdentity"), __s2_len < 4) ? (__builtin_constant_p (element_name) && ((size_t)(const void *)((element_name) + 1) - (size_t)(const void *)(element_name) == 1) ? __builtin_strcmp (element_name, "assemblyIdentity") : (__extension__ ({ __const unsigned char *__s1 = (__const unsigned char *) (__const char *) (element_name); register int __result = __s1[0] - ((__const unsigned char *) (__const char *) ("assemblyIdentity"))[0]; if (__s2_len > 0 && __result == 0) { __result = (__s1[1] - ((__const unsigned char *) (__const char *) ("assemblyIdentity"))[1]); if (__s2_len > 1 && __result == 0) { __result = (__s1[2] - ((__const unsigned char *) (__const char *) ("assemblyIdentity"))[2]); if (__s2_len > 2 && __result == 0) __result = (__s1[3] - ((__const unsigned char *) (__const char *) ("assemblyIdentity"))[3]); } } __result; }))) : __builtin_strcmp (element_name, "assemblyIdentity")))); })) {
  for (n = 0; attribute_names [n]; n++) {
   const gchar *attribute_name = attribute_names [n];

   if (!__extension__ ({ size_t __s1_len, __s2_len; (__builtin_constant_p (attribute_name) && __builtin_constant_p ("name") && (__s1_len = strlen (attribute_name), __s2_len = strlen ("name"), (!((size_t)(const void *)((attribute_name) + 1) - (size_t)(const void *)(attribute_name) == 1) || __s1_len >= 4) && (!((size_t)(const void *)(("name") + 1) - (size_t)(const void *)("name") == 1) || __s2_len >= 4)) ? __builtin_strcmp (attribute_name, "name") : (__builtin_constant_p (attribute_name) && ((size_t)(const void *)((attribute_name) + 1) - (size_t)(const void *)(attribute_name) == 1) && (__s1_len = strlen (attribute_name), __s1_len < 4) ? (__builtin_constant_p ("name") && ((size_t)(const void *)(("name") + 1) - (size_t)(const void *)("name") == 1) ? __builtin_strcmp (attribute_name, "name") : (__extension__ ({ __const unsigned char *__s2 = (__const unsigned char *) (__const char *) ("name"); register int __result = (((__const unsigned char *) (__const char *) (attribute_name))[0] - __s2[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (attribute_name))[1] - __s2[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (attribute_name))[2] - __s2[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (attribute_name))[3] - __s2[3]); } } __result; }))) : (__builtin_constant_p ("name") && ((size_t)(const void *)(("name") + 1) - (size_t)(const void *)("name") == 1) && (__s2_len = strlen ("name"), __s2_len < 4) ? (__builtin_constant_p (attribute_name) && ((size_t)(const void *)((attribute_name) + 1) - (size_t)(const void *)(attribute_name) == 1) ? __builtin_strcmp (attribute_name, "name") : (__extension__ ({ __const unsigned char *__s1 = (__const unsigned char *) (__const char *) (attribute_name); register int __result = __s1[0] - ((__const unsigned char *) (__const char *) ("name"))[0]; if (__s2_len > 0 && __result == 0) { __result = (__s1[1] - ((__const unsigned char *) (__const char *) ("name"))[1]); if (__s2_len > 1 && __result == 0) { __result = (__s1[2] - ((__const unsigned char *) (__const char *) ("name"))[2]); if (__s2_len > 2 && __result == 0) __result = (__s1[3] - ((__const unsigned char *) (__const char *) ("name"))[3]); } } __result; }))) : __builtin_strcmp (attribute_name, "name")))); }))
    info->name = g_strdup (attribute_values [n]);
   else if (!__extension__ ({ size_t __s1_len, __s2_len; (__builtin_constant_p (attribute_name) && __builtin_constant_p ("publicKeyToken") && (__s1_len = strlen (attribute_name), __s2_len = strlen ("publicKeyToken"), (!((size_t)(const void *)((attribute_name) + 1) - (size_t)(const void *)(attribute_name) == 1) || __s1_len >= 4) && (!((size_t)(const void *)(("publicKeyToken") + 1) - (size_t)(const void *)("publicKeyToken") == 1) || __s2_len >= 4)) ? __builtin_strcmp (attribute_name, "publicKeyToken") : (__builtin_constant_p (attribute_name) && ((size_t)(const void *)((attribute_name) + 1) - (size_t)(const void *)(attribute_name) == 1) && (__s1_len = strlen (attribute_name), __s1_len < 4) ? (__builtin_constant_p ("publicKeyToken") && ((size_t)(const void *)(("publicKeyToken") + 1) - (size_t)(const void *)("publicKeyToken") == 1) ? __builtin_strcmp (attribute_name, "publicKeyToken") : (__extension__ ({ __const unsigned char *__s2 = (__const unsigned char *) (__const char *) ("publicKeyToken"); register int __result = (((__const unsigned char *) (__const char *) (attribute_name))[0] - __s2[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (attribute_name))[1] - __s2[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (attribute_name))[2] - __s2[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (attribute_name))[3] - __s2[3]); } } __result; }))) : (__builtin_constant_p ("publicKeyToken") && ((size_t)(const void *)(("publicKeyToken") + 1) - (size_t)(const void *)("publicKeyToken") == 1) && (__s2_len = strlen ("publicKeyToken"), __s2_len < 4) ? (__builtin_constant_p (attribute_name) && ((size_t)(const void *)((attribute_name) + 1) - (size_t)(const void *)(attribute_name) == 1) ? __builtin_strcmp (attribute_name, "publicKeyToken") : (__extension__ ({ __const unsigned char *__s1 = (__const unsigned char *) (__const char *) (attribute_name); register int __result = __s1[0] - ((__const unsigned char *) (__const char *) ("publicKeyToken"))[0]; if (__s2_len > 0 && __result == 0) { __result = (__s1[1] - ((__const unsigned char *) (__const char *) ("publicKeyToken"))[1]); if (__s2_len > 1 && __result == 0) { __result = (__s1[2] - ((__const unsigned char *) (__const char *) ("publicKeyToken"))[2]); if (__s2_len > 2 && __result == 0) __result = (__s1[3] - ((__const unsigned char *) (__const char *) ("publicKeyToken"))[3]); } } __result; }))) : __builtin_strcmp (attribute_name, "publicKeyToken")))); })) {
    if (strlen (attribute_values [n]) == 17 - 1)
     g_strlcpy ((char *) info->public_key_token, attribute_values [n], 17);
   } else if (!__extension__ ({ size_t __s1_len, __s2_len; (__builtin_constant_p (attribute_name) && __builtin_constant_p ("culture") && (__s1_len = strlen (attribute_name), __s2_len = strlen ("culture"), (!((size_t)(const void *)((attribute_name) + 1) - (size_t)(const void *)(attribute_name) == 1) || __s1_len >= 4) && (!((size_t)(const void *)(("culture") + 1) - (size_t)(const void *)("culture") == 1) || __s2_len >= 4)) ? __builtin_strcmp (attribute_name, "culture") : (__builtin_constant_p (attribute_name) && ((size_t)(const void *)((attribute_name) + 1) - (size_t)(const void *)(attribute_name) == 1) && (__s1_len = strlen (attribute_name), __s1_len < 4) ? (__builtin_constant_p ("culture") && ((size_t)(const void *)(("culture") + 1) - (size_t)(const void *)("culture") == 1) ? __builtin_strcmp (attribute_name, "culture") : (__extension__ ({ __const unsigned char *__s2 = (__const unsigned char *) (__const char *) ("culture"); register int __result = (((__const unsigned char *) (__const char *) (attribute_name))[0] - __s2[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (attribute_name))[1] - __s2[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (attribute_name))[2] - __s2[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (attribute_name))[3] - __s2[3]); } } __result; }))) : (__builtin_constant_p ("culture") && ((size_t)(const void *)(("culture") + 1) - (size_t)(const void *)("culture") == 1) && (__s2_len = strlen ("culture"), __s2_len < 4) ? (__builtin_constant_p (attribute_name) && ((size_t)(const void *)((attribute_name) + 1) - (size_t)(const void *)(attribute_name) == 1) ? __builtin_strcmp (attribute_name, "culture") : (__extension__ ({ __const unsigned char *__s1 = (__const unsigned char *) (__const char *) (attribute_name); register int __result = __s1[0] - ((__const unsigned char *) (__const char *) ("culture"))[0]; if (__s2_len > 0 && __result == 0) { __result = (__s1[1] - ((__const unsigned char *) (__const char *) ("culture"))[1]); if (__s2_len > 1 && __result == 0) { __result = (__s1[2] - ((__const unsigned char *) (__const char *) ("culture"))[2]); if (__s2_len > 2 && __result == 0) __result = (__s1[3] - ((__const unsigned char *) (__const char *) ("culture"))[3]); } } __result; }))) : __builtin_strcmp (attribute_name, "culture")))); })) {
    if (!__extension__ ({ size_t __s1_len, __s2_len; (__builtin_constant_p (attribute_values [n]) && __builtin_constant_p ("neutral") && (__s1_len = strlen (attribute_values [n]), __s2_len = strlen ("neutral"), (!((size_t)(const void *)((attribute_values [n]) + 1) - (size_t)(const void *)(attribute_values [n]) == 1) || __s1_len >= 4) && (!((size_t)(const void *)(("neutral") + 1) - (size_t)(const void *)("neutral") == 1) || __s2_len >= 4)) ? __builtin_strcmp (attribute_values [n], "neutral") : (__builtin_constant_p (attribute_values [n]) && ((size_t)(const void *)((attribute_values [n]) + 1) - (size_t)(const void *)(attribute_values [n]) == 1) && (__s1_len = strlen (attribute_values [n]), __s1_len < 4) ? (__builtin_constant_p ("neutral") && ((size_t)(const void *)(("neutral") + 1) - (size_t)(const void *)("neutral") == 1) ? __builtin_strcmp (attribute_values [n], "neutral") : (__extension__ ({ __const unsigned char *__s2 = (__const unsigned char *) (__const char *) ("neutral"); register int __result = (((__const unsigned char *) (__const char *) (attribute_values [n]))[0] - __s2[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (attribute_values [n]))[1] - __s2[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (attribute_values [n]))[2] - __s2[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (attribute_values [n]))[3] - __s2[3]); } } __result; }))) : (__builtin_constant_p ("neutral") && ((size_t)(const void *)(("neutral") + 1) - (size_t)(const void *)("neutral") == 1) && (__s2_len = strlen ("neutral"), __s2_len < 4) ? (__builtin_constant_p (attribute_values [n]) && ((size_t)(const void *)((attribute_values [n]) + 1) - (size_t)(const void *)(attribute_values [n]) == 1) ? __builtin_strcmp (attribute_values [n], "neutral") : (__extension__ ({ __const unsigned char *__s1 = (__const unsigned char *) (__const char *) (attribute_values [n]); register int __result = __s1[0] - ((__const unsigned char *) (__const char *) ("neutral"))[0]; if (__s2_len > 0 && __result == 0) { __result = (__s1[1] - ((__const unsigned char *) (__const char *) ("neutral"))[1]); if (__s2_len > 1 && __result == 0) { __result = (__s1[2] - ((__const unsigned char *) (__const char *) ("neutral"))[2]); if (__s2_len > 2 && __result == 0) __result = (__s1[3] - ((__const unsigned char *) (__const char *) ("neutral"))[3]); } } __result; }))) : __builtin_strcmp (attribute_values [n], "neutral")))); }))
     info->culture = g_strdup ("");
    else
     info->culture = g_strdup (attribute_values [n]);
   }
  }
 } else if (!__extension__ ({ size_t __s1_len, __s2_len; (__builtin_constant_p (element_name) && __builtin_constant_p ("bindingRedirect") && (__s1_len = strlen (element_name), __s2_len = strlen ("bindingRedirect"), (!((size_t)(const void *)((element_name) + 1) - (size_t)(const void *)(element_name) == 1) || __s1_len >= 4) && (!((size_t)(const void *)(("bindingRedirect") + 1) - (size_t)(const void *)("bindingRedirect") == 1) || __s2_len >= 4)) ? __builtin_strcmp (element_name, "bindingRedirect") : (__builtin_constant_p (element_name) && ((size_t)(const void *)((element_name) + 1) - (size_t)(const void *)(element_name) == 1) && (__s1_len = strlen (element_name), __s1_len < 4) ? (__builtin_constant_p ("bindingRedirect") && ((size_t)(const void *)(("bindingRedirect") + 1) - (size_t)(const void *)("bindingRedirect") == 1) ? __builtin_strcmp (element_name, "bindingRedirect") : (__extension__ ({ __const unsigned char *__s2 = (__const unsigned char *) (__const char *) ("bindingRedirect"); register int __result = (((__const unsigned char *) (__const char *) (element_name))[0] - __s2[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (element_name))[1] - __s2[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (element_name))[2] - __s2[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (element_name))[3] - __s2[3]); } } __result; }))) : (__builtin_constant_p ("bindingRedirect") && ((size_t)(const void *)(("bindingRedirect") + 1) - (size_t)(const void *)("bindingRedirect") == 1) && (__s2_len = strlen ("bindingRedirect"), __s2_len < 4) ? (__builtin_constant_p (element_name) && ((size_t)(const void *)((element_name) + 1) - (size_t)(const void *)(element_name) == 1) ? __builtin_strcmp (element_name, "bindingRedirect") : (__extension__ ({ __const unsigned char *__s1 = (__const unsigned char *) (__const char *) (element_name); register int __result = __s1[0] - ((__const unsigned char *) (__const char *) ("bindingRedirect"))[0]; if (__s2_len > 0 && __result == 0) { __result = (__s1[1] - ((__const unsigned char *) (__const char *) ("bindingRedirect"))[1]); if (__s2_len > 1 && __result == 0) { __result = (__s1[2] - ((__const unsigned char *) (__const char *) ("bindingRedirect"))[2]); if (__s2_len > 2 && __result == 0) __result = (__s1[3] - ((__const unsigned char *) (__const char *) ("bindingRedirect"))[3]); } } __result; }))) : __builtin_strcmp (element_name, "bindingRedirect")))); })) {
  for (n = 0; attribute_names [n]; n++) {
   const gchar *attribute_name = attribute_names [n];

   if (!__extension__ ({ size_t __s1_len, __s2_len; (__builtin_constant_p (attribute_name) && __builtin_constant_p ("oldVersion") && (__s1_len = strlen (attribute_name), __s2_len = strlen ("oldVersion"), (!((size_t)(const void *)((attribute_name) + 1) - (size_t)(const void *)(attribute_name) == 1) || __s1_len >= 4) && (!((size_t)(const void *)(("oldVersion") + 1) - (size_t)(const void *)("oldVersion") == 1) || __s2_len >= 4)) ? __builtin_strcmp (attribute_name, "oldVersion") : (__builtin_constant_p (attribute_name) && ((size_t)(const void *)((attribute_name) + 1) - (size_t)(const void *)(attribute_name) == 1) && (__s1_len = strlen (attribute_name), __s1_len < 4) ? (__builtin_constant_p ("oldVersion") && ((size_t)(const void *)(("oldVersion") + 1) - (size_t)(const void *)("oldVersion") == 1) ? __builtin_strcmp (attribute_name, "oldVersion") : (__extension__ ({ __const unsigned char *__s2 = (__const unsigned char *) (__const char *) ("oldVersion"); register int __result = (((__const unsigned char *) (__const char *) (attribute_name))[0] - __s2[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (attribute_name))[1] - __s2[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (attribute_name))[2] - __s2[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (attribute_name))[3] - __s2[3]); } } __result; }))) : (__builtin_constant_p ("oldVersion") && ((size_t)(const void *)(("oldVersion") + 1) - (size_t)(const void *)("oldVersion") == 1) && (__s2_len = strlen ("oldVersion"), __s2_len < 4) ? (__builtin_constant_p (attribute_name) && ((size_t)(const void *)((attribute_name) + 1) - (size_t)(const void *)(attribute_name) == 1) ? __builtin_strcmp (attribute_name, "oldVersion") : (__extension__ ({ __const unsigned char *__s1 = (__const unsigned char *) (__const char *) (attribute_name); register int __result = __s1[0] - ((__const unsigned char *) (__const char *) ("oldVersion"))[0]; if (__s2_len > 0 && __result == 0) { __result = (__s1[1] - ((__const unsigned char *) (__const char *) ("oldVersion"))[1]); if (__s2_len > 1 && __result == 0) { __result = (__s1[2] - ((__const unsigned char *) (__const char *) ("oldVersion"))[2]); if (__s2_len > 2 && __result == 0) __result = (__s1[3] - ((__const unsigned char *) (__const char *) ("oldVersion"))[3]); } } __result; }))) : __builtin_strcmp (attribute_name, "oldVersion")))); })) {
    gchar **numbers, **version, **versions;
    gint major, minor, build, revision;


    if (!__extension__ ({ size_t __s1_len, __s2_len; (__builtin_constant_p (attribute_values [n]) && __builtin_constant_p ("") && (__s1_len = strlen (attribute_values [n]), __s2_len = strlen (""), (!((size_t)(const void *)((attribute_values [n]) + 1) - (size_t)(const void *)(attribute_values [n]) == 1) || __s1_len >= 4) && (!((size_t)(const void *)(("") + 1) - (size_t)(const void *)("") == 1) || __s2_len >= 4)) ? __builtin_strcmp (attribute_values [n], "") : (__builtin_constant_p (attribute_values [n]) && ((size_t)(const void *)((attribute_values [n]) + 1) - (size_t)(const void *)(attribute_values [n]) == 1) && (__s1_len = strlen (attribute_values [n]), __s1_len < 4) ? (__builtin_constant_p ("") && ((size_t)(const void *)(("") + 1) - (size_t)(const void *)("") == 1) ? __builtin_strcmp (attribute_values [n], "") : (__extension__ ({ __const unsigned char *__s2 = (__const unsigned char *) (__const char *) (""); register int __result = (((__const unsigned char *) (__const char *) (attribute_values [n]))[0] - __s2[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (attribute_values [n]))[1] - __s2[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (attribute_values [n]))[2] - __s2[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (attribute_values [n]))[3] - __s2[3]); } } __result; }))) : (__builtin_constant_p ("") && ((size_t)(const void *)(("") + 1) - (size_t)(const void *)("") == 1) && (__s2_len = strlen (""), __s2_len < 4) ? (__builtin_constant_p (attribute_values [n]) && ((size_t)(const void *)((attribute_values [n]) + 1) - (size_t)(const void *)(attribute_values [n]) == 1) ? __builtin_strcmp (attribute_values [n], "") : (__extension__ ({ __const unsigned char *__s1 = (__const unsigned char *) (__const char *) (attribute_values [n]); register int __result = __s1[0] - ((__const unsigned char *) (__const char *) (""))[0]; if (__s2_len > 0 && __result == 0) { __result = (__s1[1] - ((__const unsigned char *) (__const char *) (""))[1]); if (__s2_len > 1 && __result == 0) { __result = (__s1[2] - ((__const unsigned char *) (__const char *) (""))[2]); if (__s2_len > 2 && __result == 0) __result = (__s1[3] - ((__const unsigned char *) (__const char *) (""))[3]); } } __result; }))) : __builtin_strcmp (attribute_values [n], "")))); }))
     return;
    ...
    g_strfreev (versions);
   } else if (!__extension__ ({ size_t __s1_len, __s2_len; (__builtin_constant_p (attribute_name) && __builtin_constant_p ("newVersion") && (__s1_len = strlen (attribute_name), __s2_len = strlen ("newVersion"), (!((size_t)(const void *)((attribute_name) + 1) - (size_t)(const void *)(attribute_name) == 1) || __s1_len >= 4) && (!((size_t)(const void *)(("newVersion") + 1) - (size_t)(const void *)("newVersion") == 1) || __s2_len >= 4)) ? __builtin_strcmp (attribute_name, "newVersion") : (__builtin_constant_p (attribute_name) && ((size_t)(const void *)((attribute_name) + 1) - (size_t)(const void *)(attribute_name) == 1) && (__s1_len = strlen (attribute_name), __s1_len < 4) ? (__builtin_constant_p ("newVersion") && ((size_t)(const void *)(("newVersion") + 1) - (size_t)(const void *)("newVersion") == 1) ? __builtin_strcmp (attribute_name, "newVersion") : (__extension__ ({ __const unsigned char *__s2 = (__const unsigned char *) (__const char *) ("newVersion"); register int __result = (((__const unsigned char *) (__const char *) (attribute_name))[0] - __s2[0]); if (__s1_len > 0 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (attribute_name))[1] - __s2[1]); if (__s1_len > 1 && __result == 0) { __result = (((__const unsigned char *) (__const char *) (attribute_name))[2] - __s2[2]); if (__s1_len > 2 && __result == 0) __result = (((__const unsigned char *) (__const char *) (attribute_name))[3] - __s2[3]); } } __result; }))) : (__builtin_constant_p ("newVersion") && ((size_t)(const void *)(("newVersion") + 1) - (size_t)(const void *)("newVersion") == 1) && (__s2_len = strlen ("newVersion"), __s2_len < 4) ? (__builtin_constant_p (attribute_name) && ((size_t)(const void *)((attribute_name) + 1) - (size_t)(const void *)(attribute_name) == 1) ? __builtin_strcmp (attribute_name, "newVersion") : (__extension__ ({ __const unsigned char *__s1 = (__const unsigned char *) (__const char *) (attribute_name); register int __result = __s1[0] - ((__const unsigned char *) (__const char *) ("newVersion"))[0]; if (__s2_len > 0 && __result == 0) { __result = (__s1[1] - ((__const unsigned char *) (__const char *) ("newVersion"))[1]); if (__s2_len > 1 && __result == 0) { __result = (__s1[2] - ((__const unsigned char *) (__const char *) ("newVersion"))[2]); if (__s2_len > 2 && __result == 0) __result = (__s1[3] - ((__const unsigned char *) (__const char *) ("newVersion"))[3]); } } __result; }))) : __builtin_strcmp (attribute_name, "newVersion")))); })) {
