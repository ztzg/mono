...
{
	[TestFixture] public class SqlCommand_Parameters : ADONetTesterClass
	{
		Exception exp;
		...
		private void CommandParameterTreatBitAsBoolean()
		{
			exp=null;
			SqlConnection con = new SqlConnection(DataProvider.ConnectionStringSQLClient);
			try
			{
		...
		/// </summary>
		private void DoTestparametersBindByNameOnMSSQLServer()
		{
