...
namespace GHTUtils.Data
{
	...
	/// </summary>
	public class DbTypeParametersCollection : System.Collections.CollectionBase
	{
		#region Constructors
		/// <summary>
		/// Default constructor.
		...
		public string ColumnsList
		{
			get
			{
				System.Text.StringBuilder l_sbColumnsList = new System.Text.StringBuilder();;
		...
		public string ValuesList
		{
			get
			{
				System.Text.StringBuilder l_sbValuesList = new System.Text.StringBuilder();
		...
		#region Methods
		#region Public
		#region System.Collections.CollectionBase implementation
		/// <summary>
		...
		public virtual int ExecuteInsert(string a_sUniqueId)
		{
			...
			l_cmdInsert.Connection = new OleDbConnection(DataProvider.ConnectionString);
			...
			try
			{
				...
				// System.Console.WriteLine(l_cmdInsert.CommandText);
		...
		public static int ExecuteDelete(string a_sTableName, string a_sUniqueId)
		{
			...
			l_cmdDelete.Connection = new OleDbConnection(DataProvider.ConnectionString);
		...
		{
			if ( value.GetType() != Type.GetType("GHTUtils.Data.DbTypeParameter") )
		...
		{
			if ( newValue.GetType() != Type.GetType("GHTUtils.Data.DbTypeParameter") )
		...
		private OleDbCommand BuildSelectCommand(string a_sUniqueId)
		{
			string l_sColumnsList = ColumnsList;
			string l_sCmdTxt;
			OleDbConnection l_oConnection = new OleDbConnection(DataProvider.ConnectionString);
